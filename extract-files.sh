...
function blob_fixup() {
    case "${1}" in
        ...
        vendor/lib64/vendor.qti.hardware.camera.postproc@1.0-service-impl.so)
            ...
            ;;
        odm/bin/hw/vendor.oplus.hardware.biometrics.fingerprint@2.1-service|odm/bin/hw/vendor.oplus.hardware.biometrics.fingerprint@2.1-service_uff)
            "${PATCHELF}" --add-needed "libshims_fingerprint.oplus" "${2}"
            ;;
